      ...
      appBar: AppBar(
        ...
        title: TextField(
          ...
          decoration: InputDecoration(
            hintText: 'Buscar receta...', // Texto en español
      ...
      return Center(
        child: Column(
          ...
          children: [
            ...
            Text(
              'Busca tu receta favorita', // Texto en español
            ...
            Text(
              'Por ejemplo: pasta, pollo, sushi...', // Ejemplos localizados
      ...
      return Center(
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 16),
            Text(
              'Sin resultados', // Texto en español
              style: GoogleFonts.playfairDisplay(
                fontSize: 20,
                color: const Color(0xFF888888),
              ),
            ...
            const SizedBox(height: 8),
            Text(
              'Prueba con otra palabra clave', // Sugerencia en español
              style: GoogleFonts.nunito(
                fontSize: 14,
                color: const Color(0xFFAAAAAA),
              ),
