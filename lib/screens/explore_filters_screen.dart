        ...
        child: Column(
          ...
          children: [
            ...
            _AreaChips(
              ...
              onSelected: (a) => setState(() => _selectedArea = a),
            ),
            ...
            _IngredientChips(
              ...
              onSelected: (i) => setState(() => _selectedIngredient = i),
            ),
    ...
    return areasAsync.when(
      ...
      data: (areas) => Wrap(
        ...
        children: areas
            ...
            .map(
              (a) => ChoiceChip(
                label: Text(Translator.area(a)),
                selected: selected == a,
                onSelected: (v) => onSelected(v ? a : null),
                selectedColor: const Color(0xFFE8490F).withValues(alpha: 0.2),
              ),
            )
            .toList(),
      ),
        ...
        children: ings
            ...
            .map(
              (i) => ChoiceChip(
                label: Text(i),
                selected: selected == i,
                onSelected: (v) => onSelected(v ? i : null),
                selectedColor: const Color(0xFFE8490F).withValues(alpha: 0.2),
              ),
            )
            .toList(),
...
class _ResultsGrid extends ConsumerWidget {
  ...
  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final async = ingredient != null
        ? ref.watch(mealsByIngredientProvider(ingredient!))
